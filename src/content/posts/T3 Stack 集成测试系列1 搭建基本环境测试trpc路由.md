...
![vitest 基础测试通过](<./_assets/T3 Stack 集成测试系列1 搭建基本环境测试trpc路由/base-test.png>)
...
![环境变量未加载报错](<./_assets/T3 Stack 集成测试系列1 搭建基本环境测试trpc路由/env-err.png>)
...
![接入真实路由后的测试结果](<./_assets/T3 Stack 集成测试系列1 搭建基本环境测试trpc路由/base-test-with-router.png>)
...
![受保护路由测试通过](<./_assets/T3 Stack 集成测试系列1 搭建基本环境测试trpc路由/base-test-with-protected-router.png>)
...
![Next Auth Error 报错截图](<./_assets/T3 Stack 集成测试系列1 搭建基本环境测试trpc路由/err-next-auth.png>)
...
![cache is not a function 报错截图](<./_assets/T3 Stack 集成测试系列1 搭建基本环境测试trpc路由/err-(0 , cache) is not a function.png>)
